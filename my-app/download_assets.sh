...
SCREEN_3_ID="d9ea55688cb24d9f90ea66de5e5551ec"
...
# Screen 3
curl -L -o "assets/screen_${SCREEN_3_ID}.png" "https://storage.googleapis.com/stitch-artifacts/projects/${PROJECT_ID}/screens/${SCREEN_3_ID}/image.png"
curl -L -o "src/screen_${SCREEN_3_ID}.html" "https://storage.googleapis.com/stitch-artifacts/projects/${PROJECT_ID}/screens/${SCREEN_3_ID}/code.html"
